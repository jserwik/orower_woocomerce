<?php
/**
 * Shopwell Customizer custom textarea control class.
 *
 * @package     Shopwell
...
if ( ! class_exists( 'Shopwell_Customizer_Control_Textarea' ) ) :
	/**
	 * Shopwell Customizer custom select control class.
	 */
	class Shopwell_Customizer_Control_Textarea extends Shopwell_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="shopwell-control-wrapper shopwell-textarea-wrapper">
