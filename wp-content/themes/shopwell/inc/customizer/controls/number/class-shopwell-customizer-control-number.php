...
if ( ! class_exists( 'Shopwell_Customizer_Control_Number' ) ) :
	/**
	 * Shopwell Customizer custom select control class.
	 */
	class Shopwell_Customizer_Control_Number extends Shopwell_Customizer_Control {
