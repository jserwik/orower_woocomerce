...
if ( ! class_exists( 'Shopwell_Customizer_Control_Range' ) ) :
	/**
	 * Shopwell Customizer custom heading control class.
	 */
	class Shopwell_Customizer_Control_Range extends Shopwell_Customizer_Control {
		...
		public function enqueue() {
			parent::enqueue();
			$base_font_size = \Shopwell\Helper::get_option( 'html_base_font_size' );
		...
		protected function content_template() {
			?>
			<div class="shopwell-range-wrapper shopwell-control-wrapper">
				...
				<div class="shopwell-control-wrap" data-unit="{{ data.value['unit'] }}">
