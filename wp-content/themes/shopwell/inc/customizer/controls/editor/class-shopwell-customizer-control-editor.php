...
/**
 * Shopwell Customizer editor control class.
 */
class Shopwell_Customizer_Control_Editor extends Shopwell_Customizer_Control {
	/**
	...
	protected function content_template() {
		?>
		<div class="shopwell-control-wrapper wp-js-editor shopwell-textarea-wrapper">
			<label>
				<# if ( data.label ) { #>
