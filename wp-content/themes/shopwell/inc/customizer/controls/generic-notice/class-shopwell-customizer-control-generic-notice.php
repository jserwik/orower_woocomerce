 ...
 * @access public
 */
class Shopwell_Customizer_Control_Generic_Notice extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'shopwell-generic-notice';
	...
	/**
	 * Shopwell_Hiding_Section constructor.
	 *
	...
	public function enqueue() {
		Shopwell_Customizer_Plugin_Install_Helper::instance()->enqueue_scripts();
	}
	...
	public function create_plugin_install_button( $slug, $settings = array() ) {
		return Shopwell_Customizer_Plugin_Install_Helper::instance()->get_button_html( $slug, $settings );
	}
}
