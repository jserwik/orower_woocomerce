...
if ( ! class_exists( 'Shopwell_Customizer_Control_Button' ) ) :
	/**
	 * Shopwell Customizer custom background control class.
	 */
	class Shopwell_Customizer_Control_Button extends Shopwell_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="shopwell-button-wrapper shopwell-control-wrapper">
