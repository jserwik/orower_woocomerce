<?php
/**
 * Shopwell Customizer custom spacing control class.
 *
 * @package     Shopwell
...
if ( ! class_exists( 'Shopwell_Customizer_Control_Spacing' ) ) :
	/**
	 * Shopwell Customizer custom select control class.
	 */
	class Shopwell_Customizer_Control_Spacing extends Shopwell_Customizer_Control {
		...
		public function to_json() {
			...
			$this->json['title']   = esc_html__( 'Link values', 'shopwell' );
		...
		protected function content_template() {
			?>
			<div class="shopwell-control-wrapper shopwell-spacing-wrapper<# if ( data.responsive ) { #> shopwell-control-responsive <# } #>">
