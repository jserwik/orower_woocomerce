...
/**
 * Shopwell helper class to handle fonts.
 *
 * @since 1.0.0
 */
class Fonts {
	 ...
	 * @since 1.0.0
	 *
	 * @return Array All the system fonts in Shopwell
	 */
	public function get_system_fonts() {
		...
		return apply_filters( 'shopwell_system_fonts', $this->system_fonts );
	}
	...
	public function get_standard_fonts() {
		...
		return apply_filters( 'shopwell_standard_fonts', $standard_fonts );
	}
	...
	public function get_default_system_font() {
		...
		return apply_filters( 'shopwell_default_system_font', $font );
	}
	...
	public function get_google_fonts() {
		...
		if ( empty( $this->google_fonts ) ) {
			...
			$google_fonts_file = apply_filters( 'shopwell_google_fonts_json_file', SHOPWELL_THEME_PATH . '/assets/fonts/google-fonts.json' );
		...
		return apply_filters( 'shopwell_google_fonts', $this->google_fonts );
	}
	...
	public function get_google_font_subsets() {
		...
		$subsets = array(
			'arabic'              => esc_html__( 'Arabic', 'shopwell' ),
			'bengali'             => esc_html__( 'Bengali', 'shopwell' ),
			'chinese-hongkong'    => esc_html__( 'Chinese (Hong Kong)', 'shopwell' ),
			'chinese-simplified'  => esc_html__( 'Chinese (Simplified)', 'shopwell' ),
			'chinese-traditional' => esc_html__( 'Chinese (Traditional)', 'shopwell' ),
			'cyrillic'            => esc_html__( 'Cyrillic', 'shopwell' ),
			'cyrillic-ext'        => esc_html__( 'Cyrillic Extended', 'shopwell' ),
			'devanagari'          => esc_html__( 'Devanagari', 'shopwell' ),
			'greek'               => esc_html__( 'Greek', 'shopwell' ),
			'greek-ext'           => esc_html__( 'Greek Extended', 'shopwell' ),
			'gujarati'            => esc_html__( 'Gujarati', 'shopwell' ),
			'gurmukhi'            => esc_html__( 'Gurmukhi', 'shopwell' ),
			'hebrew'              => esc_html__( 'Hebrew', 'shopwell' ),
			'japanese'            => esc_html__( 'Japanese', 'shopwell' ),
			'kannada'             => esc_html__( 'Kannada', 'shopwell' ),
			'khmer'               => esc_html__( 'Khmer', 'shopwell' ),
			'korean'              => esc_html__( 'Korean', 'shopwell' ),
			'latin'               => esc_html__( 'Latin', 'shopwell' ),
			'latin-ext'           => esc_html__( 'Latin Extended', 'shopwell' ),
			'malayalam'           => esc_html__( 'Malayalam', 'shopwell' ),
			'myanmar'             => esc_html__( 'Myanmar', 'shopwell' ),
			'oriya'               => esc_html__( 'Oriya', 'shopwell' ),
			'sinhala'             => esc_html__( 'Sinhala', 'shopwell' ),
			'tamil'               => esc_html__( 'Tamil', 'shopwell' ),
			'telugu'              => esc_html__( 'Telugu', 'shopwell' ),
			'thai'                => esc_html__( 'Thai', 'shopwell' ),
			'vietnamese'          => esc_html__( 'Vietnamese', 'shopwell' ),
		);

		return apply_filters( 'shopwell_google_font_subsets', $subsets );
	}
	...
	public function get_backup_fonts() {
		...
		return apply_filters( 'shopwell_backup_fonts', $backup_fonts );
	}
	...
	public function enqueue_google_fonts() {
		...
		$fonts = get_transient( 'shopwell_google_fonts_enqueue' );
	...
	public function enqueue_google_font( $family, $args = array() ) {
		...
		set_transient( 'shopwell_google_fonts_enqueue', $fonts );
	}
	...
	public function get_fonts() {
		...
		$fonts['standard_fonts'] = array(
			'name'  => esc_html__( 'Standard', 'shopwell' ),
			'fonts' => self::get_standard_fonts(),
		);

		$fonts['system_fonts'] = array(
			'name'  => esc_html__( 'System Fonts', 'shopwell' ),
			'fonts' => self::get_system_fonts(),
		);

		$fonts['google_fonts'] = array(
			'name'  => esc_html__( 'Google Fonts', 'shopwell' ),
			'fonts' => self::get_google_fonts(),
		);

		return apply_filters( 'shopwell_get_fonts', $fonts );
	}
	...
	public function get_font_family( $font ) {
		...
		return apply_filters( 'shopwell_font_family', $font );
	}
}
