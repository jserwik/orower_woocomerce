		...
		<p class="return-to-shop">
			<a class="button wc-backward<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
				<?php
					 ...
					 */
					echo esc_html( apply_filters( 'woocommerce_return_to_shop_text', __( 'Shop What&rsquo;s New', 'shopwell' ) ) );
				?>
			</a>
		</p>
	<?php endif; ?>
	...
	<p class="empty-cart-button-sign-in">
		<a class="button wc-backward" href="<?php echo esc_url( apply_filters( 'woocommerce_sign_in_redirect', wc_get_page_permalink( 'myaccount' ) ) ); ?>">
			<?php
				 ...
				 * @param string $default_text Default text.
				 */
				echo esc_html( apply_filters( 'woocommerce_return_to_shop_text', __( 'Sign in', 'shopwell' ) ) );
			?>
		</a>
	</p>
</div>
